...
export default function Home() {
  return (
    <div className="">
      ...
      <div className="absolute left-[50%] top-[-20rem] z-0 ml-[-20rem] h-[40rem] w-[40rem] rounded-full bg-[#D1A8FF] blur-3xl opacity-10"></div>
      <div className="absolute left-[50%] top-[40rem] z-0 ml-[-20rem] h-[40rem] w-[40rem] rounded-full bg-[#D1A8FF] blur-3xl opacity-10"></div>
